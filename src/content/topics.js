...
export const cryptogamologyTextCz = () =>
  <span>
    ...
    terestrickými lišejníky v borových lesích a v arkto-alpinské tundře a
    vodními a půdními rozsivkami. Algologický výzkum je zaměřen především na
    rozsivky v polárních oblastech, kde patří tyto jednobuněčné řasy s
    ...
    monitoring vzácných druhů. Specializovanější projekty zahrnují například
    studium bioindikační role epifytických druhů, sledování zachovalosti
    pralesovitých porostů na druzích tlejícího dřeva a monitorování úspěšnosti
    revitalizačních zásahů na rašeliništích. Pro naši práci využíváme i
    nejmodernější molekulární metody (např. next-generation sequencing), kde se
    soustředíme hlavně na odhalení vnitrodruhové struktury populací, odrazem
...
export const cryptogamologyTextEn = () => 
  <span>
    ...
    terrestrial lichens in pine forests or arctic-alpine tundra, and freshwater
    and soil diatoms. Algological research focuses mainly on the diatoms in
    polar regions, in which these unicellular organisms with siliceous shells
    ...
    with the emphasis on the monitoring of rare species. In the specialized
    projects we study, e.g. the bioindication potential of epiphytic species,
    state of old-growth forests based on the composition of species on decaying
    wood, and monitoring of restored mires. For our work we use as well the most
...
export const mireEcologyTextEn = () => 
  <span>
    ...
    permanently high water levels and limited nutrient availability. A great
    variety of rare and endangered species is associated with these ecosystems,
    which are, however, quickly disappearing from the central-European
    landscape. Groundwater-supplied mires, so called fens, represent the most
    threatened mire type. In Europe only small remnants have been preserved,
    mainly as regularly mown fen meadows. Rainwater-supplied mires, so called
    bogs, are unique mainly for playing a key role in biogeochemical cycles. In
    ...
    parameters, using the same methodology in all the regions. However, we also
    pay attention to the current state of mires in particular regions in
...
export const mireEcologyTextCz = () => 
  <span>
    ...
    vysokou hladinou vody a nedostatkem přístupných živin. Vyskytuje se na nich
    celá řada vzácných a ohrožených organismů. Ve střední Evropě však
    rašeliniště velmi rychle mizí. Nejohroženější jsou rašeliniště sycená
    podzemní vodou, takzvaná slatiniště. Ve střední Evropě se zachovaly jen
    jejich zbytky, a to převážně jako sečené slatinné louky. Rašeliniště sycená
    srážkovou vodou, takzvaná vrchoviště, jsou zase významná z důvodu jejich
    ...
    metodologie v různých územích. Stejně tak se ale zabýváme i výzkumem
    aktuálního stavu rašelinišť v jednotlivých oblastech a současnými změnami
...
export const palaeoEcologyTextEn = () => 
  <span>
    ...
    ecosystems, in relation to climate changes and human impact. Such knowledge
    helps us to understand the current patterns of biota. This type of research
    ...
    due to permanent water saturation, which prevents the decomposition of
    organic matter. In our research we use both biological objects (so called
    “subfossils”), and geochemical and sedimentological analyses. The age can be
    accurately estimated via the radiocarbon dating. The data about the species
    occurrence allow us to reconstruct past environmental changes qualitatively,
    ...
    reconstructions more accurate and allows us to estimate changes of
    temperature (chironomids), moisture (testate amoebae), calcium richness
    (plant macroremains, molluscs) and nutrient richness (diatoms). The
...
export const palaeoEcologyTextCz = () => 
  <span>
    ...
    změnách klimatu a vlivu člověka. Tyto znalosti nám pomáhají pochopit podobu
    ...
    biologických objektů (tzv. subfosilií), tak i geochemické a sedimentologické
    analýzy. Stáří se přesně stanovuje za pomoci radiokarbonového datování.
    Údaje o výskytu druhů pak vedou k rekonstrukci změn prostředí v minulosti, a
    ...
    změny teploty (pakomáři), vlhkosti (krytenky), vápnitosti (makrozbytky,
...
export const relictEcosystemsTextEn = () => 
  <span>
    ...
    the past, since the Last Glacial Maximum before ca. 24 000 years. In the
    ...
    the Carpathians. These belong to the most species-rich grasslands across the
    globe, hosting a number of relict species. We try to examine to what extent
    their uniqueness is linked with their past Quaternary history, historical as
    well as current management, and current local conditions. We try to find out
    which species of our flora might represent relicts, to recognize their
    distribution and ecological preferences, and to understand how we can
    effectively protect them for generations to come. We are also interested in
    ecosystems that were common during the different time periods since the Last
    Glacial Maximum up to the Holocene Climate Optimum, yet are rare or absent
    in the current landscape. We found a variety of such ecosystems in the
    mountain ranges of southern Siberia. Studies of these ecosystems can help us
    create a more precise picture of the glacial landscape in central Europe. In
    the same way, it was also useful to study current communities of southern
    Ural that represent apparent analogues to our forest ecosystems at the onset
    of the Holocene. At present we explore the distribution of selected species
    in the boreal and temperate zones of Northern Hemisphere, trying to
    understand the impact of Pleistocene glacial cycles on their distribution
...
export const relictEcosystemsTextCz = () => 
  <span>
    ...
    nejbohatším loukám na světě, a dodnes se na nich vyskytují reliktní druhy.
    Zkoumáme, nakolik se na jejich mimořádnosti podílí vliv dávné čtvrtohorní
    historie, historického i současného obhospodařování a současných podmínek
    prostředí. Snažíme se přijít na to, které druhy naší flóry jsou
    pravděpodobně relikty, jaké je jejich rozšíření a ekologické nároky, a jak
    je můžeme účinně chránit pro další generace. Zajímají nás i další
    ekosystémy, které byly v naší přírodě běžné v jednotlivých obdobích od
    posledního glaciálního maxima až po klimatické optimum Holocénu, a dnes jsou
    u nás vzácné nebo se už nevyskytují. Řadu takových ekosystémů jsme nalezli v
    pohořích jižní Sibiře. Jejich studiem můžeme výrazně upřesnit naše představy
    o podobě glaciální krajiny u nás. Obdobně přínosné bylo studium současných
    společenstev jižního Uralu, které vykazují nápadnou podobu s našimi lesními
    společenstvy v počátku Holocénu. Aktuálně sledujeme rozšíření vybraných
    druhů v boreální a temperátní zóně severní polokoule a snažíme se pochopit
    vliv pleistocenních zalednění na jejich rozšíření a evoluci pomocí
