...
export const databasesCz = [
    {
      name: `Databáze rostlinných makrozbytků`,
      link: `http://www.sci.muni.cz/botany/mirecol/paleo/en/`
    },
    {
...
export const media = [
  ...
  {
    name: `19/11/2017 Kde stála sklárna, orchideje nerostou, zjistili vědci na Žítkové, iDNES.cz`,
    link: `https://zlin.idnes.cz/vedci-orchideje-zitkova-bile-karpaty-masarykova-univerzita-brno-phv-/zlin-zpravy.aspx?c=A171116_364836_zlin-zpravy_ras`
  },
  {
    name: `02/11/2017 Národní finále Science slamu vyhrála brněnská botanička Barbora Chattová, Online.muni.cz`,
    link: `https://www.online.muni.cz/student/9854-narodni-finale-science-slamu-vyhrala-brnenska-botanicka-barbora-chattova`
  },
  {
    name: `01/11/2017 Soutěž Science Slam ovládla brněnská vědkyně. S výzkumem mikroskopických řas, Brněnský deník`,
    link: `https://brnensky.denik.cz/zpravy_region/soutez-science-slam-ovladla-brnenska-vedkyne-s-vyzkumem-mikroskopickych-ras-20171101.html`
  },
  {
    name: `31/07/2017 Na místě bývalé sklárny po 300 letech stále nerostou orchideje, Online.muni.cz`,
    link: `https://www.online.muni.cz/veda-a-vyzkum/9515-na-miste-byvale-sklarny-po-300-letech-stale-nerostou-orchideje`
  },
  {
    name: `21/04/2017 Bělokarpatské louky bez orchidejí: tam, kde stávaly sklárny, Český rozhlas`,
    link: `https://brno.rozhlas.cz/belokarpatske-louky-bez-orchideji-tam-kde-stavaly-sklarny-6460766`
  },
  {
    name: `08/04/2017 Měkkýši z glaciálu, Česká televize, Týden v regionech`,
    link: `https://www.ceskatelevize.cz/ivysilani/1181680258-tyden-v-regionech-brno/317281381890408-tyden-v-regionech/obsah/536085-mekkysi-z-glacialu`
  },
  {
    name: `20/03/2017 Záhada fosilie z Červeného kopce, Online.muni.cz`,
    link: `https://www.online.muni.cz/veda-a-vyzkum/9011-zahada-tajemne-fosilie-z-cerveneho-kopce-je-vyresena`
  },
  {
  ...
  },
  {
    ...
    link: `https://21stoleti.cz/2007/04/19/doba-ledova-nebyla-tak-hroziva/`
  }
];
